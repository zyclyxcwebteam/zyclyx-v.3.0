    ...
    <Layout>
      <Container fluid className="privacy-outer py-md-5 p-1 privacy-page">
        <Container className="p-md-5 p-1 privacy-inner">
          <h1 className="py-2">
            Privacy Policy for ZYCLYX CONSULTING SERVICES PVT.LTD
          </h1>

          <p>
            At ZYCLYX CONSULTING SERVICES PVT.LTD, accessible from
            https://zyclyx.com/, one of our main priorities is the privacy of
            our visitors. This Privacy Policy document contains types of
            information that is collected and recorded by ZYCLYX CONSULTING
            SERVICES PVT.LTD and how we use it.
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in ZYCLYX CONSULTING SERVICES
            PVT.LTD. This policy is not applicable to any information collected
          ...
          <p>
            ZYCLYX CONSULTING SERVICES PVT.LTD follows a standard procedure of
          ...
          <p>
            ...
            advertising partners of ZYCLYX CONSULTING SERVICES PVT.LTD.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on ZYCLYX CONSULTING
            SERVICES PVT.LTD, which are sent directly to users&apos; browser.
          ...
          <p>
            Note that ZYCLYX CONSULTING SERVICES PVT.LTD has no access to or
          ...
          <p>
            ZYCLYX CONSULTING SERVICES PVT.LTD&apos;s Privacy Policy does not
