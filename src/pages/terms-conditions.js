...
const Terms = () => {
  return (
    <Layout>
      <Container fluid className="privacy-outer py-md-5 p-1 privacy-page">
        <Container className="p-md-5 p-1 privacy-inner">
          <h1>
            <strong>Terms and Conditions</strong>
          </h1>

          <p>Welcome to ZYCLYX CONSULTING SERVICES PVT.LTD!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of ZYCLYX CONSULTING SERVICES PVT.LTD&apos;s Website, located at
            https://zyclyx.com/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use ZYCLYX CONSULTING SERVICES
            PVT.LTD if you do not agree to take all of the terms and conditions
            stated on this page.
          </p>
          ...
          <p>
            We employ the use of cookies. By accessing ZYCLYX CONSULTING
            SERVICES PVT.LTD, you agreed to use cookies in agreement with the
            ZYCLYX CONSULTING SERVICES PVT.LTD&apos;s Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, ZYCLYX CONSULTING SERVICES PVT.LTD and/or
            its licensors own the intellectual property rights for all material
            on ZYCLYX CONSULTING SERVICES PVT.LTD. All intellectual property
            rights are reserved. You may access this from ZYCLYX CONSULTING
            SERVICES PVT.LTD for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from ZYCLYX CONSULTING SERVICES PVT.LTD</li>
            <li>
              Sell, rent or sub-license material from ZYCLYX CONSULTING SERVICES
              PVT.LTD
            </li>
            <li>
              Reproduce, duplicate or copy material from ZYCLYX CONSULTING
              SERVICES PVT.LTD
            </li>
            <li>
              Redistribute content from ZYCLYX CONSULTING SERVICES PVT.LTD
            </li>
          </ul>
          ...
          <p>
            ...
            ZYCLYX CONSULTING SERVICES PVT.LTD does not filter, edit, publish or
            review Comments prior to their presence on the website. Comments do
            not reflect the views and opinions of ZYCLYX CONSULTING SERVICES
            PVT.LTD,its agents and/or affiliates. Comments reflect the views and
            opinions of the person who post their views and opinions. To the
            extent permitted by applicable laws, ZYCLYX CONSULTING SERVICES
            PVT.LTD shall not be liable for the Comments or for any liability,
          ...
          <p>
            ZYCLYX CONSULTING SERVICES PVT.LTD reserves the right to monitor all
          ...
          <p>
            You hereby grant ZYCLYX CONSULTING SERVICES PVT.LTD a non-exclusive
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of ZYCLYX
            CONSULTING SERVICES PVT.LTD; and (d) the link is in the context of
          ...
          <p>
            ...
            sending an e-mail to ZYCLYX CONSULTING SERVICES PVT.LTD. Please
          ...
          <p>
            No use of ZYCLYX CONSULTING SERVICES PVT.LTD&apos;s logo or other
